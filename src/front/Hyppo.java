...
import debug.Logger;
import io.HyperspectralImageReader;
import io.HyperspectralImageWriter;
...
public class Hyppo {
	...
	public static HyperspectralImage readImage(String path) throws IOException {
		return HyperspectralImageReader.read(path);
	}
	public static HyperspectralImage readImage(String path, String headerPath) throws IOException {
		return HyperspectralImageReader.read(path, headerPath);
	}
